-- pgque.sql — vendored from https://github.com/NikolayS/pgque
-- Pin: commit 7366982ef0d8f837d69b296236cce6e08eb74ba1 (2026-05-01)
-- Version: 1.0.0-dev (no stable tag at vendor time; pinned to HEAD of main)
--
-- Refresh procedure (see db/README.md):
--   git clone https://github.com/NikolayS/pgque.git /tmp/pgque_refresh
--   # choose a tag or commit to pin
--   cp /tmp/pgque_refresh/sql/pgque.sql db/pgque.sql
--   # update the Pin line above, commit with message:
--   # "chore(db): refresh pgque vendor to <tag/commit>"
--
-- Do NOT edit below this line — it is an unmodified upstream copy.
-- ─────────────────────────────────────────────────────────────────────────────
